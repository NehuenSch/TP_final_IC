Algoritmo TP_Integrador
	...
	// Cliente VIP: se otroga una tarjeta VIP al cliente que tenga un registro de 8 alquileres realizado (cada alquiler debe de ser superior a una semana), 
	...
	// 	del 15% y en caso de ser temporada de invierno el equipamiento de invierno sera cortecia de la agencia. 
	// Sistema de alquiler de vehiculos 4x4 o traccion simple (El usuario alquilara segun su conveniencia). 
	...
	// diciembre a febrero (verano) se sumara un 30% a las tarifas. Se debe de tener en cuenta la precuacion segun la zona a circular (generar avisos antes de finalizar el contrato).
	// Precio por unidad traccion simple: Precio base del vehiculo por es de Dia = $30.000; Dos dias = $60.000 - 5% -> $57.000;
	// 		Precio por semana = $210.000 - 5% -> $199.500; Precio por mes o mas = $900.000 - 10% + dias extra -> $855.000 + dia extra.
	// Precio por unidad de 4x4: Precio base del vehiculo por es de Dia = $45.000; Dos dias = $90.000 - 5% -> $85.500;
	// 		Precio por semana = $315.000 - 5% -> $299.250; Precio por mes o mas = $1.350.000 - 10% + dias extra -> $1.282.500 + dia extra.
